...
import youKeepUsingThatWordImg from '../../assets/you-keep-using-that-word/you-keep-using-that-word.jpg';
import progressiveEnhancementImg from '../../assets/you-keep-using-that-word/progressive-enhancement.jpg';
import techniqueChartImg from '../../assets/you-keep-using-that-word/technique-chart.jpg';
import mobileFirstImg from '../../assets/you-keep-using-that-word/mobile-first.jpg';
import desktopFirstImg from '../../assets/you-keep-using-that-word/desktop-first.jpg';
import adaptiveImg from '../../assets/you-keep-using-that-word/adaptive.jpg';
...
<Image
  src={youKeepUsingThatWordImg}
  alt="Scene from The Princess Bride"
  width={700}
	height={385}
/>
...
<Image
  src={techniqueChartImg}
  alt="Chart of responsive web design, progressive enhancement, and graceful degradation"
  width={700}
	height={525}
/>
