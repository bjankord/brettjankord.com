...
import githubBranchChecksImg from '$/assets/how-i-set-up-my-github-repos-for-easy-maintenance/github-branch-checks.png';
import autoDeleteBranchImg from '$/assets/how-i-set-up-my-github-repos-for-easy-maintenance/auto-delete-branch.png';
...
<Image
  src={githubBranchChecksImg}
  alt="GitHub branch checks"
  width={700}
	height={491}
/>
...
<Image
  src={autoDeleteBranchImg}
  alt="Auto-delete branch"
  width={700}
	height={91}
/>
