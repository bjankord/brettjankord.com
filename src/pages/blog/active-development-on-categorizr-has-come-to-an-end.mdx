...
import unifiedDeviceDesignImg from '../../assets/active-development-on-categorizr-has-come-to-an-end/unified-device-design.png';
...
<Image
  src={unifiedDeviceDesignImg}
  alt="Unified device design"
  width={700}
	height={523}
/>
