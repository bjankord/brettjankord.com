...
import testAllImg from '$/assets/beyond-device-detection/test-all-the-devices.jpg';
...
<Image
  src={testAllImg}
  alt="Pile of web enabled devices with text overlaid on top that reads, Gotta catch 'em all"
  width={700}
	height={525}
/>
